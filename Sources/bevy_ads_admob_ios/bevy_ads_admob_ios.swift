...
func __swift_bridge__AdMobManager_show_banner_ad (_ this: UnsafeMutableRawPointer, _ position: Int32) -> Bool {
    Unmanaged<AdMobManager>.fromOpaque(this).takeUnretainedValue().show_banner_ad(position: position)
}
...
@_cdecl("__swift_bridge__$AdMobManager$is_banner_ready")
func __swift_bridge__AdMobManager_is_banner_ready (_ this: UnsafeMutableRawPointer) -> Bool {
    Unmanaged<AdMobManager>.fromOpaque(this).takeUnretainedValue().is_banner_ready()
}
...
@_cdecl("__swift_bridge__$AdMobManager$is_privacy_options_required")
func __swift_bridge__AdMobManager_is_privacy_options_required (_ this: UnsafeMutableRawPointer) -> Bool {
    Unmanaged<AdMobManager>.fromOpaque(this).takeUnretainedValue().is_privacy_options_required()
}

@_cdecl("__swift_bridge__$AdMobManager$show_privacy_options_form")
func __swift_bridge__AdMobManager_show_privacy_options_form (_ this: UnsafeMutableRawPointer) -> Bool {
    Unmanaged<AdMobManager>.fromOpaque(this).takeUnretainedValue().show_privacy_options_form()
}
...
public func on_ad_failed_to_present<GenericIntoRustString: IntoRustString>(_ ad_type: GenericIntoRustString, _ error: GenericIntoRustString) {
    __swift_bridge__$on_ad_failed_to_present({ let rustString = ad_type.intoRustString(); rustString.isOwned = false; return rustString.ptr }(), { let rustString = error.intoRustString(); rustString.isOwned = false; return rustString.ptr }())
}
